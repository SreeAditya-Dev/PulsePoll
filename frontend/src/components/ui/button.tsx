  ...
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 cursor-pointer active:scale-[0.97]',
  {
    variants: {
      variant: {
        ...
        gradient:
          'bg-gradient-to-r from-primary via-[hsl(280,70%,60%)] to-accent text-white shadow-lg shadow-primary/25 hover:shadow-primary/40 hover:brightness-110 bg-[length:200%_100%] hover:bg-right transition-[background-position,box-shadow] duration-500',
        destructive:
